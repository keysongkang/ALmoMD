...
def cont_NVTLangevin_bias_temp(
    ...
    forces, step_std = get_forces_bias_temp(struc, inputs.nstep, inputs.nmodel, calculator, inputs.harmonic_F, inputs.anharmonic_F, criteria_collected, inputs.al_type, inputs.bias_A, inputs.bias_B, inputs.idx_atom, E_ref)
...
def get_forces_bias_temp(
    struc, nstep, nmodel, calculator, harmonic_F, anharmonic_F, criteria, al_type, bias_A, bias_B, idx_atom, E_ref
):
    """Function [get_forces]
