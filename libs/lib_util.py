        ...
        for line in f: # Go through line by line
            ...
            if line and not line.startswith('#'): # Skip lines starting with a # symbol
                ...
                if name in ['supercell', 'supercell_init', 'mask']:
                    ...
                    value = float(value)
                elif name in ['ntrain_init', 'ntrain', 'nstep', 'nmodel', 'temperature', 'taut', 'pressure', 'taup', 'steps_ther', 'steps_init', 'timestep', 'cutoff_ther', 'lmax', 'nfeatures', 'random_index', 'wndex', 'steps', 'loginterval', 'num_calc']:
                    value = int(value)
                else:
                    value = str(value)
