...
def cont_NVTLangevin_meta(
    ...
    forces = get_forces_meta(struc, inputs.nstep, inputs.nmodel, calculator, inputs.harmonic_F, inputs.anharmonic_F, criteria_collected, inputs.meta_Ediff, E_ref)
...
def get_forces_meta(
    struc, nstep, nmodel, calculator, harmonic_F, anharmonic_F, criteria, meta_Ediff, E_ref
):
    """Function [get_forces]
